...
//const wallet = Keypair.fromSecretKey(bs58.decode(process.env.PRIVATE_KEY)); // your wallet  REMOVED, NO LONGER NEEDED
...
const ADMIN_WALLET_SECRET_KEY_ENCODED = process.env.ADMIN_WALLET_SECRET_KEY_ENCODED;
...
module.exports = {
  ...
  ADMIN_WALLET_SECRET_KEY_ENCODED
};
